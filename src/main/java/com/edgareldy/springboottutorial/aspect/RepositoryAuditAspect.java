package com.edgareldy.springboottutorial.aspect;
...
public class RepositoryAuditAspect {
    ...
    @Before("execution(* com.edgareldy.springboottutorial.repository..*(..))")
    public void logBefore(JoinPoint joinPoint) {
        log.debug("About to call {}", joinPoint.getSignature().toShortString());
    }

    @After("execution(* com.edgareldy.springboottutorial.repository..*(..))")
    public void logAfter(JoinPoint joinPoint) {
        log.debug("Finished calling {}", joinPoint.getSignature().toShortString());
    }

    @AfterReturning(pointcut = "execution(* com.edgareldy.springboottutorial.repository..*.save(..))", returning = "result")
    public void logAfterReturning(JoinPoint joinPoint, Object result) {
        log.info("{} persisted {}", joinPoint.getSignature().toShortString(), result);
    }

    @AfterThrowing(pointcut = "execution(* com.edgareldy.springboottutorial.repository..*(..))", throwing = "ex")
